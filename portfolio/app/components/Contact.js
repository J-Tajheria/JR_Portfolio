...
const Contact = () => {
    ...
    return (
        <div id='contact' className='bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] w-full px-[12%] py-10 scroll-mt-20
        dark:bg-none'>
            ...
            I would love to hear from you! If you have any enquires, comments or feedback, please use the form below.
            </p>
