  ...
  return (
    <div className='w-11/12 max-w-3xl mx-auto text-center h-screen flex flex-col justify-center items-center gap-4'>
      <motion.div initial={{scale:0}} whileInView={{scale:1}} transition={{duration: 0.8, type: 'spring', stiffness:100}}>
        <Image src={assets.portfolio_headshot} alt="profile_pic" className='rounded-full w-32'/>
      </motion.div>
      <motion.h3 
      ...
      <div className='flex flex-col sm:flex-row items-center gap-4'mt-4>
        ...
        <motion.a 
        initial={{y: 30, opacity: 0}} whileInView={{y:0, opacity:1}} transition={{duration: 0.6, delay: 1}}
        href="/sample-resume.pdf" download className='px-10 py-3 border border-gray-500 rounded-full flex items-center gap-2 dark:text-black dark:bg-white'>
          My CV
